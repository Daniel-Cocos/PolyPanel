...
function FooterSection() {
  ...
  return (
    <Box component="footer" sx={{ py: { xs: 3, md: 4.5 }, bgcolor: '#49c889', borderTop: '1px solid rgba(4,32,24,0.22)' }}>
      <Container maxWidth={false} sx={{ width: { xs: 'min(1200px, calc(100% - 24px))', sm: 'min(1200px, calc(100% - 32px))' } }}>
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={{ xs: 2.5, md: 4 }} sx={{ justifyContent: 'space-between', alignItems: { xs: 'flex-start', md: 'flex-end' } }}>
          <Box sx={{ display: 'grid', gap: 0.8 }}>
            <Typography sx={{ color: '#042018', fontWeight: 800, letterSpacing: '0.01em', fontSize: '1.42rem', lineHeight: 1.1 }}>PolyPanel</Typography>
            ...
            <Typography sx={{ color: 'rgba(4,32,24,0.72)', mt: 0.35, fontSize: '0.92rem', letterSpacing: '0.01em' }}>
              {year} PolyPanel. All rights reserved.
            </Typography>
          </Box>
          ...
          <Box sx={{ display: 'grid', gap: 0.75 }}>
            ...
            <Stack direction="row" spacing={{ xs: 0.9, md: 2.5 }} sx={{ flexWrap: 'wrap', rowGap: 0.6, columnGap: 1.1 }}>
